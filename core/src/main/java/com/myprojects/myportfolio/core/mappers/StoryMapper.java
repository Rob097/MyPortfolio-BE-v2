...
public abstract class StoryMapper extends BaseMapper<Story, StoryDto> {
    ...
    public abstract StoryDto mapToDto(Story entity, IView view);
    ...
    public abstract Story mapToDao(StoryDto dto);
